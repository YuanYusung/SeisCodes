# -*- coding: utf-8 -*-
# Modifiled from seispy.decon(https://github.com/xumi1993/seispy) by Yusong Yuan, Oct 13th, 2025
import numpy as np
...
def gfilter(x, nfft, gauss, dt):
    ...
    Xf = fft(x, nfft)
    Xf = Xf * gauss * dt
    return ifft(Xf, nfft).real

def correl(R, W, nfft):
    """ Correlation in frequency domain """
    return ifft(fft(R, nfft) * np.conj(fft(W, nfft)), nfft).real
